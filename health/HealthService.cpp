 ...
 */
#define LOG_TAG "android.hardware.health@2.0-service.pme"
...
using ::device::htc::pme::health::CycleCountBackupRestore;
using ::device::htc::pme::health::LearnedCapacityBackupRestore;
